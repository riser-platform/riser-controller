...
require (
	...
	github.com/riser-platform/riser-server/api/v1/model v0.0.7-0.20200126114256-d1497446eec0
	github.com/riser-platform/riser/sdk v0.0.20-0.20200126114641-6b286d9f7e5b
