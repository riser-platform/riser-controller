...
require (
	...
	github.com/riser-platform/riser-server/api/v1/model v0.0.7-0.20200124170529-632726c14f38
	github.com/riser-platform/riser/sdk v0.0.20-0.20200124171321-510acdd0da28
