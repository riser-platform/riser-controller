...
require (
	...
	github.com/riser-platform/riser-server/api/v1/model v0.0.0-20191113114704-5da99c8e2b9c
	github.com/riser-platform/riser/sdk v0.0.0-20191116082310-ef5deefbcb65
